...
class Simple {
    ...
    public function save_custom_data($from, $object_type, $object_id) {
        ...
        $this->db_save_data($object_type, $object_id, $this->custom_data[$object_type][$object_id]);
    }
    ...
    private function db_save_data($type, $id, $data) {
        if (!$type || !$id) {
            return false;
        }
    ...
    public function add_static($template, $page) {
        $this->document->addStyle('catalog/view/theme/'.$template.'/stylesheet/simple.css?v='.self::$version);
        $this->document->addScript('catalog/view/javascript/simple.js?v='.self::$version);
        $this->document->addScript('catalog/view/javascript/'.$page.'.js?v='.self::$version);
