...
$_['column_quantity']                = '<span title="Кількість"> Кількість </span>';
$_['column_price']                   = 'Ціна';
...
$_['error_no_payment']               = 'Пожалуйста выберете способ доставки! Обратитесь к <a href="%s">Администрации</a>!';
...
$_['error_no_shipping']              = 'Доставка по данному адресу невозможна! Обратитесь к <a href="%s">Администрации</a>!';
$_['error_payment']                  = 'Выберете пожалуйста, способ оплаты';
