    ...
    function getQuote($address) {
        ...
        if ($status) {
            ...
            $quote_data['gunsel'] = array(
                ...
                'cost' => $cost,
                'tax_class_id' => 0,
				'text'         => ''//'Стоимость можно рассчитать, с помощью <a href="http://gunsel.ua/index.php?option=com_content&view=article&id=10&Itemid=5&lang=ru" target="_blank">калькулятора</a> на сайте Деливериа' //$this->currency->format($cost)
            );
