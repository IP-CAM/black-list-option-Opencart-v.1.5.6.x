    ...
    function getQuote($address) {
        ...
        if ($status) {
            ...
            $quote_data['nexpress'] = array(
                ...
                'cost' => $cost,
                'tax_class_id' => 0,
				'text'         => ''//'Стоимость можно рассчитать, с помощью <a href="http://www.nexpress.com.ua/calculator" target="_blank">калькулятора</a> на сайте Ночного Экспресса' //$this->currency->format($cost)
            );
