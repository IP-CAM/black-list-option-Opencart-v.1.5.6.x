    ...
    function getQuote($address) {
        ...
        if ($status) {
            ...
            $quote_data['novaposhta'] = array(
                ...
                'cost' => $cost,
                'tax_class_id' => 0,
				'text'         => ''//'Стоимость можно рассчитать, с помощью <a href="http://novaposhta.ua/frontend/calculator?lang=ru" target="_blank">калькулятора</a> на сайте Новой Почты' //$this->currency->format($cost)
            );
