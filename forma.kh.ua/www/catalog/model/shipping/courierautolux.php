    ...
    function getQuote($address) {
        ...
        if ($status) {
            ...
            $quote_data['courierautolux'] = array(
                ...
                'cost' => $cost,
                'tax_class_id' => 0,
				'text'         => ''//'Стоимость можно рассчитать, с помощью <a href="http://autolux.ua/Kalkulyator_stoimosti" target="_blank">калькулятора</a> на сайте ЕвроЭкспресса' //$this->currency->format($cost)
