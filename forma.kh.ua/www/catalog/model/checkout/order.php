	...
	public function confirm($order_id, $order_status_id, $comment = '', $notify = false) {
		...
		if ($order_info) {
			...
			$replace = array(
				...
				'sh_method' => $order_info['shipping_method'],
			...
			$mail->setTo($this->config->get('config_email'));
			$mail->setFrom($this->config->get('config_email'));
			$mail->setSubject(html_entity_decode('Error', ENT_QUOTES, 'UTF-8'));
			$mail->setText(html_entity_decode('Order #' + $order_id + '(status:' + $order_status_id + ') not found', ENT_QUOTES, 'UTF-8'));
			$mail->send();
		}
	}
