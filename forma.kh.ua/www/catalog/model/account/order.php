...
class ModelAccountOrder extends Model {
	...
	public function getOrderProducts($order_id) {
		$query = $this->db->query("SELECT p.sku, op.order_product_id, op.order_id, op.product_id, op.name, op.model, op.quantity, op.price, op.total FROM " . DB_PREFIX . "order_product op LEFT JOIN " . DB_PREFIX . "product p ON op.product_id = p.product_id WHERE order_id = '" . (int)$order_id . "'");
