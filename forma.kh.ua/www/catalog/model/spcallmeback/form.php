	...
	public function create() {
        ...
        $echo .= '            <tr class="row last">
                ...
                <td colspan="3"  style="width:300px">
                    <input type="hidden" name="spcallmeback-recaptcha" value="">
                    <input type="hidden" name="spcallmeback-title" value="">
                    <input type="hidden" name="spcallmeback-url" value="">
                    <span class="nofocus"><input data-sitekey="6LdoW6AUAAAAALVQHhxZgcYQF3M4ib645Zx4udhb" class="spcallmeback_submit" type="submit" value="'.$this->getFieldName('form_button_caption').'" /></span>
                    <span class="spcallmeback_close_btn">'.$this->language->get('text_button_close').'</span>
                    <div class="g-recaptcha" data-sitekey="6LdoW6AUAAAAALVQHhxZgcYQF3M4ib645Zx4udhb"></div>
                </td>
            </tr>
            </table>
            </form>
            ...
            <script type="text/javascript">
                var row = $(\'.spcallmeback_wrap [name="email"]\').parent();
                $(\'.spcallmeback_wrap [name="email"]\').remove();
                row.html(\'<input type="text" name="tel" id="input-tel" value="" class="control text">\');
                $(\'[name="spcallmeback-title"]\').val(document.title);
                $(\'[name="spcallmeback-url"]\').val(window.location.href);
