...
class ModelToolSimpleGeo extends Model {
    ...
    public function getGeoIp() {
        ...
        if (!ModelToolSimpleGeo::$ip_checked) {
            ...
            $simple_geoip_mode = $this->config->get('simple_geoip_mode');

            if ($simple_geoip_mode == self::SIMPLE_GEO_OWN) {
                ModelToolSimpleGeo::$geo = $this->getGeoIpBySimpleOpenCart();
            } elseif ($simple_geoip_mode == self::SIMPLE_GEO_MAXMIND_EXTENSION) {
                ModelToolSimpleGeo::$geo = $this->getGeoIpByMaxMind();
            } elseif ($simple_geoip_mode == self::SIMPLE_GEO_MAXMIND_TABLE) {
