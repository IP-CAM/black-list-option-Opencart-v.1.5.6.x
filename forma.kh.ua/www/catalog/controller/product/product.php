...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
            ...
            //$this->data['discount_count'] = 3 - ($customer_info['discount_count']);
			...
			if ($product_info['images_option']) {
				$this->data['images_option'] = $product_info['images_option'];
			} else {
				$this->data['images_option'] = false;
			}
