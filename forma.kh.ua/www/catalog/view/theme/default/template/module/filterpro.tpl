...
<div id="filterpro_box1" class="box" style="top:0px;">  <!--id="content"-->
<div class="box-heading">
<!--<a id="filter-btn"><img src="../catalog/view/image/down.png"/><span><?php echo $heading_title; ?></span></a>-->
<span class="title"><?php echo $heading_title; ?></span><div style="height: 15px; float: right;">
...
<div class="price_slider collapsible">
	...
	<label> - </label>
	<input type="text" id="max_price" value="-1" name="max_price"  class="price_limit" style="width: 52px;">
...
<div class="option_box">
	...
	<div class="option_box">
		...
		<table <?php if(!$option['expanded']){echo 'style="display:none"';}?>>
			<?php foreach($option['option_values'] as $option_value) { ?>
			<tr>
				<td>
