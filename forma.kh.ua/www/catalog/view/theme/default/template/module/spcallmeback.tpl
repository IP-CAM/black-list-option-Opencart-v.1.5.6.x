...
<?php if ($button_position == 1 || $button_position == 2): ?>
    <div id="spcallmeback_btn_wrap_1" instid="1" class="spcallmeback_btn spcallmeback_button <?php echo $btn_class; ?>">
        <a id="spcallmeback_btn_1" class="spcallmeback_raise_btn" href="#spcallmeback_1" style="color: <?php echo $button_color; ?>; background-color: <?php echo $button_background; ?>"><?php echo $button_caption; ?></a>
    </div>
