...
<?php if ($button_position == 1 || $button_position == 2): ?>
    <div id="spcallmeback_btn_wrap_1" instid="1" class="spcallmeback_btn spcallmeback_button <?php echo $btn_class; ?>">
        <a id="spcallmeback_btn_1" class="spcallmeback_raise_btn" href="#spcallmeback_1" style="color: <?php echo $button_color; ?>; background-color: <?php echo $button_background; ?>">&#9990;</a>
    </div>
<?php elseif ($button_position == 3): ?>
    <div class="spcallmeback_btn spcallmeback_button <?php echo $btn_class; ?>">
        <a class="spcallmeback_sidebutton_inside spcallmeback_raise_btn" id="spcallmeback_btn_1" href="#spcallmeback_1" style="color: <?php echo $button_color; ?>; background-color: <?php echo $button_background; ?>">&#9990;</a>
    </div>
<?php endif ?>
