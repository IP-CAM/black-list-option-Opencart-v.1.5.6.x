...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
  <div id="currency">
    ...
    <?php } ?>
    <?php } ?>-->
    <a title="<?php echo $currency['title']; ?>" onclick="$('input[name=\'currency_code\']').attr('value', '<?php echo $currency['code']; ?>'); $(this).parent().parent().submit();">
        <?php if ($currency['code'] == "UAH") {echo "₴";} 
            else if ($currency['code'] == "RUR") {echo "P";}
            else if ($currency['code'] == "USD") {echo "$";} ?>
    </a>
    <?php } ?>
