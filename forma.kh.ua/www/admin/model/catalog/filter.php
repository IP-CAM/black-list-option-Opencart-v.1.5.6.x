...
class ModelCatalogFilter extends Model {
  ...
  public function addOption($data) {
    ...
    if (isset($data['option_value'])) {
      foreach ($data['option_value'] as $option_value) {
        $this->db->query("INSERT INTO " . DB_PREFIX . "category_option_value SET option_id = '" . (int)$option_id . "',sort_order = '" . (int)$option_value['filter_sort_order'] . "'");
  ...
  public function editOption($option_id, $data) {
    ...
    if (isset($data['option_value'])) {
      foreach ($data['option_value'] as $value_id => $value) {
        $this->db->query("INSERT INTO " . DB_PREFIX . "category_option_value SET option_id = '" . (int)$option_id . "', value_id = '" . (int)$value_id . "', sort_order = '" . (int)$value['filter_sort_order'] . "'");
  ...
  public function getOptionValues($option_id) {
    ...
    foreach ($value_query->rows as $option_value) {
      ...
      $value_data[] = array(
        ...
        'filter_sort_order'    => $option_value['sort_order'],        
  ...
  public function createTables() {
		...
		$sql = "
       CREATE TABLE `" . DB_PREFIX . "category_option` (
      ...
      CREATE TABLE `" . DB_PREFIX . "category_option_description` (
      ...
      CREATE TABLE `" . DB_PREFIX . "category_option_to_category` (
        `option_id` int(11) NOT NULL,
        `category_id` int(11) NOT NULL,
        PRIMARY KEY  (`category_id`,`option_id`)
      ) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

      CREATE TABLE `" . DB_PREFIX . "category_option_value` (
      ...
      CREATE TABLE `" . DB_PREFIX . "category_option_value_description` (
      ...
      CREATE TABLE `" . DB_PREFIX . "product_to_value` (
    ...
    ";
		...
		if ($this->showTable('category_option')) {
      return TRUE;
    } else {
      return FALSE;
    }
