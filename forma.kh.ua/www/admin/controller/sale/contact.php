...
class ControllerSaleContact extends Controller {
	...
	public function index() {
		...
		// News/*  
					...
					$results = $this->model_catalog_news->getNewsShorts(4);
					...
					foreach ($results as $result) {
						...
						$this->data['latest_news'][] = array(
							'title'        		=> $result['title'],
							'description'  		=> utf8_substr(strip_tags(html_entity_decode($result['description'], ENT_QUOTES, 'UTF-8')), 0, 256),
							'href'         		=> str_replace('/admin/', '/' ,$this->url->link('information/news', 'news_id=' . $result['news_id'])),
