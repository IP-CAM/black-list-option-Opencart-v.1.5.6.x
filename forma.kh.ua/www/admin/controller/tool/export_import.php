...
class ControllerToolExportImport extends Controller { 
	...
	protected function getForm() {
		...
		$this->data['text_used_category_ids'] = $this->language->get('text_used_category_ids');
		$this->data['text_used_product_ids'] = $this->language->get('text_used_product_ids');
		...
		$this->data['help_category_filter'] = $this->language->get( 'help_category_filter' );
		...
		$this->data['text_used_category_ids'] = str_replace('%1',$min_category_id,$this->data['text_used_category_ids']);
		$this->data['text_used_category_ids'] = str_replace('%2',$max_category_id,$this->data['text_used_category_ids']);
		$this->data['text_used_product_ids'] = str_replace('%1',$min_product_id,$this->data['text_used_product_ids']);
		$this->data['text_used_product_ids'] = str_replace('%2',$max_product_id,$this->data['text_used_product_ids']);
