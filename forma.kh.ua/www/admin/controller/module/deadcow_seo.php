...
class ControllerModuleDeadcowSEO extends Controller {
    ...
    public function install() {
        ...
        $this->model_setting_setting->editSetting('deadcow_seo', array('deadcow_seo_categories_template' => '[category_name]',
            ...
            'deadcow_seo_meta_template' => '[product_name], [model_name], [manufacturer_name], [categories_names]',
             'deadcow_seo_description_template' => '[product_name],[price], [description],[model_name], [manufacturer_name], [categories_names]',
			'deadcow_seo_title_template' => '[product_name], [price], [model_name], [manufacturer_name], [categories_names]',
    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validate())) {
            ...
            if (isset($this->request->post['meta_keywords'])) {
			 ...
			 if (isset($this->request->post['meta_description'])) {
                if (!isset($this->request->post['yahoo_checkbox'])) {
                    $this->model_module_deadcow_seo->generateMetaDescription($this->request->post['description_template'], null, $this->request->post['source_language_code']);
                } else if (trim($this->request->post['yahoo_id']) != '') {
                    $this->model_module_deadcow_seo->generateMetaDescription($this->request->post['description_template'], trim($this->request->post['yahoo_id']), $this->request->post['source_language_code']);
                } else {
                    $this->error['warning'] = $this->language->get('enter_yahoo_id');
                }
            }
			if (isset($this->request->post['seo_title'])) {
                if (!isset($this->request->post['yahoo_checkbox'])) {
                    $this->model_module_deadcow_seo->generateSeoTitle($this->request->post['title_template'], null, $this->request->post['source_language_code']);
                } else if (trim($this->request->post['yahoo_id']) != '') {
                    $this->model_module_deadcow_seo->generateSeoTitle($this->request->post['title_template'], trim($this->request->post['yahoo_id']), $this->request->post['source_language_code']);
                } else {
                    $this->error['warning'] = $this->language->get('enter_yahoo_id');
                }
            }
            ...
            $this->model_setting_setting->editSetting('deadcow_seo', array('deadcow_seo_categories_template' => $this->request->post['categories_template'],
                ...
                'deadcow_seo_description_template' => $this->request->post['description_template'],
				'deadcow_seo_title_template' => $this->request->post['title_template'],
		...
		$this->data['meta_description'] = $this->language->get('meta_description');
		$this->data['warning_clear_description'] = $this->language->get('warning_clear_description');
		$this->data['available_description_tags'] = $this->language->get('available_description_tags');
		 $this->data['seo_title'] = $this->language->get('seo_title');
		 $this->data['warning_clear_title'] = $this->language->get('warning_clear_title');
		$this->data['available_title_tags'] = $this->language->get('available_title_tags');	
        ...
        if (isset($this->request->post['meta_template'])) {
		 ...
		 if (isset($this->request->post['description_template'])) {
            $this->data['description_template'] = $this->request->post['description_template'];
        } else {
            $this->data['description_template'] = $this->config->get('deadcow_seo_description_template');
        }
		if (isset($this->request->post['title_template'])) {
            $this->data['title_template'] = $this->request->post['title_template'];
        } else {
            $this->data['title_template'] = $this->config->get('deadcow_seo_title_template');
        }
