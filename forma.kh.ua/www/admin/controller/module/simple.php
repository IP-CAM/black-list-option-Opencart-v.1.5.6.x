...
class ControllerModuleSimple extends Controller {
    ...
    public function index() {
        ...
        $this->data['zones'] = $this->model_localisation_zone->getZonesByCountryId($this->data['simple_fields_main']['main_country_id']['init']);
    ...
    public function custom() {
        ...
        $this->data['custom'] = $this->model_tool_simplecustom->loadData($this->request->get['type'],$this->request->get['id']);
