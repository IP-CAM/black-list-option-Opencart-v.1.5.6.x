...
<div id="content">
  ...
  <!--
            ...
            <tr>
              ...
              <td><input type="number" name="location" value="<?php echo $location; ?>" /></td>
            </tr>
			           <tr>
              <td>Ширина картинки в каталоге</td>
...
<?php //var_dump($attribute_row);?>
                ...
                <?php if ($product_attribute['attr_check'] == true){ ?>
                    <label class="checkbox-inline"><input type="checkbox" checked name="product_attribute[<?php echo $attribute_row; ?>][attr_check]" value="1">Отображать в категории</label>
                <?php } else { ?>
                    <label class="checkbox-inline"><input type="checkbox" name="product_attribute[<?php echo $attribute_row; ?>][attr_check]" value="1">Отображать в категории</label>
                <?php } ?>
              ...
              <tbody id="option-value-row<?php echo $option_value_row; ?>">
                <tr>
                  ...
                  <td class="right"><select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][weight_prefix]">
                    ...
                    <td class="left"><input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][image_num]" value="<?php echo $product_option_value['image_num']; ?>" size="3"/></td>
          ...
          <table id="discount" class="list">
            <thead>
              <tr>
                ...
                <td class="right">Количество для применения скидки</td>
      ...
      <div id="tab-special">
        ...
        <div id="tab-image">
          <?php if ($product_options) { ?>
            Опция: 
            <select name="images_option">
              <option value="0"><?php echo $text_none; ?></option>
              <?php foreach ($product_options as $option) { ?>
              <?php if ("option[".$option['product_option_id']."]" === $images_option) { ?>
              <option value="option[<?php echo $option['product_option_id']; ?>]" selected><?php echo $option['name']; ?></option>
              <?php } else { ?>
              <option value="option[<?php echo $option['product_option_id']; ?>]" ><?php echo $option['name']; ?></option>
              <?php }} ?>
            </select>
          <?php } ?>
...
function addDiscount() {
	...
	html += '    <td class="right"><input type="text" name="product_discount[' + discount_row + '][percent]" value="" /></td>';
