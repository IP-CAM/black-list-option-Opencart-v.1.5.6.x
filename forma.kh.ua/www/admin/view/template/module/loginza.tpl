    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        ...
        <tr>
          ...
          <td><select name="loginza_status">
              <?php if ($loginza_status) { ?>
        ...
        <tr>
          ...
          <td><input type="text" name="loginza_sort_order" value="<?php echo $loginza_sort_order; ?>" size="1" /></td>
        </tr>
