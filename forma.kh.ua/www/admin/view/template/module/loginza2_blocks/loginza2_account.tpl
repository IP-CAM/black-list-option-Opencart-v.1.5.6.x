...
<div class="content account_loginza_button_content">		
			<div  class="account_button_right">
...
<div class="content account_loginza_button_content">				
			<? if( $loginza2_label ) { ?>
				<div class="account_icons_header"><? echo $loginza2_label; ?></div><br>
			<? } ?>
		  
		  
		  <div class="account_icons_links">
