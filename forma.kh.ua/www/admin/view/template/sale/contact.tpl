    ...
    <div class="content">
        <table id="mail" class="form">
          ...
          <tr>
            ...
            <td><textarea name="message" id="cke"></textarea></td>
          </tr>
		  
		  <tr>
            <td><span class="required">*</span>Добавить новые товары и статьи к письму</td>
			...
			<table cellspacing="0" border="0" cellpadding="0" width="624">
				<tbody><tr>
					<td>
						...
						<h3 style="font-size: 24px; font-family: Helvetica, Arial, sans-serif; color: #333 !important; margin: 0px;">Статьи</h3>
							...
							<table cellspacing="0" border="0" cellpadding="0" width="624">
											...
											<tr>
												<td valign="top" width="378">
													<h3 style="font-size: 24px; font-family: Helvetica, Arial, sans-serif; color: #333 !important; margin: 0px;"><a href="<?php echo $latest_new['href']; ?>"><?php echo $latest_new['title']; ?></a></h3>
													<?php echo $latest_new['posted']; ?></br>
													<p style="font-size: 17px; line-height: 24px; font-family: Georgia, 'Times New Roman', Times, serif; color: #333; margin: 0px;"><?php echo $latest_new['description']; ?> <a href="<?php echo $latest_new['href']; ?>" style="color: #4b98d7; text-decoration: none;">Подробнее ›</a></p>
												</td>
												</tr>
							</tbody></table>
						<?php } ?>	
