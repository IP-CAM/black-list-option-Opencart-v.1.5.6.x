...
<script type="text/javascript" src="view/javascript/plupload/js/i18n/ru.js"></script>
<style type="text/css">
body {
	padding: 0;
	margin: 0;
...
#visualFeedback { width: 240px;  position: fixed; left: 30px; bottom: 35px; border: 2px solid #fbfbfb; z-index: 99; background: #000; border-radius: 8px; box-shadow: 0px 0px 10px #ccc; overflow: hidden; display: none; }
...
<div id="container">
  ...
  <button id="btnTextView" class="btn">TextView</button>
   ...
   <span style="float: right;  font-size: 10px; padding: 11px;">IM+ by Salab</span>
	<div id="searchBox">
					...
					success: function(json) {
						...
						if (json.length == 0) {
							...
							for (i = 0; i < json.length; i++) {
								...
								size = json[i]['size']; 
								html += '<a  file="' + json[i]['file'] + '" style="float: left;" title="' + filename +'">';
								html += '<img src="' + json[i]['file_href'] + '" title="" style="" /><br />';
								html +='<span class="fileName">' + name + '</span><span class="fileSize">' + size + '</span><input type="hidden" name="image" value="' + json[i]['file'] + '" /></a>';
							}
...
$('input#search').keyup(function(event) {
	...
	$('#uploadmulti').click(function() { 
		...
		max_file_size : '300mb', // allowed by OC '300kb',
		chunk_size : '1mb',
		unique_names : false,
		...
		filters : [
			{title : "Allowed files", extensions : "jpg,gif,png,pdf,zip,swf,rar,exe,doc,docx,txt"} //,
		],
