      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          ...
          <tr>
            ...
            <td><input type="text" name="discount_totals" value="<?php echo $discount_totals; ?>" size="15" /></td>
          </tr>
          <td><?php echo $entry_customer_group; ?></td>
	  <td>
		  <select name="discount_customer_group_id">
					<option value="0">-</option>

                    <?php foreach ($customer_groups as $customer_group) { ?>
                    <?php if ($customer_group['customer_group_id'] == $discount_customer_group_id) { ?>
